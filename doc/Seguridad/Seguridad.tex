    ...
    \chapter{Vulnerabilidades}
        ...
        \section{Inyección}
            ...
            \subsection{Cross-Site Scripting (XSS)}
                ...
                \subsubsection{Solución}
                    La solucion a este problema se vera mas adelante en la seccion 3.5
            \clearpage
        ...
        \section{Fallos en la monitorizacion de la seguridad}
            ...
            \subsection{Configuracion de logs del sistema}
                ...
                \subsubsection{Solución}
                    Para solucionar este problema, hemos hecho varias cosas:
                    \begin{itemize}
                        \item Hemos configurado los logs del sistema para que los archivos relacionados con apache y php se guarden en un logo
                        \item Hemos implementado una logica del log del lado del servidor para guardar los logs de los usuarios.
                    \end{itemize}
            \clearpage
