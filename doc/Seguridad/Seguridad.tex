...
\begin{document}
    ...
    \chapter{Primera auditoria}
        ...
        \section{ZAP}
            ...
            \end{figure}
            Como podemos ver en la imagen, tenemos un total de 16 errores, los cuales iremos comentando uno a uno en los siguientes apartados y solucionando.
        \clearpage
        \section{sqlmap}
        ...
        \section{Metaexploit}
            ...
            \end{figure}
            Al tener una contraseña tan debil enseguida nos ha encontrado las credenciales de phpMyAdmin.
        \clearpage
