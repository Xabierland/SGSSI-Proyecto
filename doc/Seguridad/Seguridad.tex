        ...
        \section{Configuración de seguridad insuficiente}
            ...
            \subsection{Despliegue seguro}
                ...
                \subsubsection{Solución}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.55\textwidth]{./img/vulnerabilidades/3.5/2.1.png}
            ...
            \subsection{Cabecera X-XSS-Protection}
                ...
                \subsubsection{Solución}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.7\textwidth]{./img/vulnerabilidades/3.5/5.1.png}
            ...
            \subsection{Cabecera X-Content-Type-Options}
                ...
                \subsubsection{Solución}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.7\textwidth]{./img/vulnerabilidades/3.5/6.1.png}
            ...
            \subsection{Configuracion Apache}
                ...
                \subsubsection{Solución}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.7\textwidth]{./img/vulnerabilidades/3.5/15.1.png}
